# Generated by Django 3.2.13 on 2022-11-01 16:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('grade', models.IntegerField(default=0, help_text='0~5사이 값으로 입력하세요', validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)], verbose_name='숫자')),
                ('image', imagekit.models.fields.ProcessedImageField(blank=True, upload_to='images/')),
